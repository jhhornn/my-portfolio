...
const projects = [
    ...
    {
        id: "nestjs-odoo",
        name: "@jhhornn/nestjs-odoo",
        description:
            "Production-ready NestJS package for integrating applications with Odoo ERP through a typed XML-RPC client, reusable domain modules, secure API access, caching, and reliable webhook delivery.",
        tech: [
            "NestJS",
            "TypeScript",
            "Odoo",
        ...
        features: [
            "Typed XML-RPC client for querying and modifying Odoo models",
            "Reusable modules for partners, products, invoices, payments, and taxes",
            "Scoped API-key authentication with Redis-backed rate limiting",
            "Redis caching with automatic model-level cache invalidation",
            "Asynchronous webhook delivery with retries and dead-letter tracking",
            "HMAC-SHA256 webhook signing and encrypted signing-secret storage",
            "SSRF protection for user-configured webhook endpoints",
            "OpenAPI documentation, DTO validation, and packaged Prisma migrations",
        ],
        links: {
            github: "https://github.com/jhhornn/odoo",
            npm: "https://www.npmjs.com/package/@jhhornn/nestjs-odoo",
        },
        status: "MAINTAINED",
        dateRange: "Jul 2025",
    },
    {
        id: "distributed-ticketing-system",
        name: "distributed-ticketing.system",
        description: "Full-stack event ticketing platform with concurrency-safe reservations, flexible seating, secure Paystack payments, and event management workflows.",
        tech: [
            "NestJS",
            "React",
            "TypeScript",
        ...
        features: [
            "Assigned seating and general admission ticket inventory",
            "Distributed locking and optimistic concurrency control to prevent double booking",
            "Time-limited reservations with automatic expiration and inventory release",
            "Secure Paystack checkout with webhook-based payment confirmation",
            "Idempotent booking operations and saga-based payment rollback",
            "Draft-to-public event publishing with section, capacity, and pricing validation",
            "Organizer dashboards for venues, events, discounts, bookings, and revenue",
            "JWT authentication with role-based access control",
        ],
        links: {
            github: "https://github.com/jhhornn/ticketing-system",
            demo: "https://ticketing-system-fe.onrender.com",
        },
        status: "IN PROGRESS",
        dateRange: "Dec 2025",
    },
